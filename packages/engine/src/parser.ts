...
export function parseSkillMd(content: string): SkillMeta {
  ...
  return {
    ...
    kind:
      meta.kind === "automation" || meta.kind === "knowledge"
        ? meta.kind
        : undefined,
    risk:
      meta.risk === "low" || meta.risk === "moderate" || meta.risk === "high"
        ? meta.risk
        : undefined,
    capabilities: isCapabilities(meta.capabilities)
      ? meta.capabilities
      : undefined,
    scripts: isScripts(meta.scripts) ? meta.scripts : undefined,
    inputs:
      typeof meta.inputs === "object" && meta.inputs !== null
        ? (meta.inputs as Record<string, InputDef>)
        : undefined,
