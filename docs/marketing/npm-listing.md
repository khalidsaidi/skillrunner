...
Today SkillRunner supports **25 skills** across code review, debugging, testing, linting, formatting, build/typecheck, dependency audits, release workflows, React maintenance, and Terraform operations.  
The catalog currently includes **14 automation skills** and **11 knowledge skills**, with **10 default-enabled** for fast onboarding.
...
With **25 production-oriented skills** and explicit `default` / `advanced` / `conditional` lanes, teams can adopt quickly and scale safely.  
