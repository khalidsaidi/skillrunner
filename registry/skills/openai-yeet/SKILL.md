---
name: openai-yeet
description: "Use only when the user explicitly asks to stage, commit, push, and open a GitHub pull request in one flow using the GitHub CLI (`gh`). (Imported from openai upstream skills)"
version: "1.0.0"
...
- Provider source: https://github.com/openai/skills/tree/main/skills/.curated/yeet
- Original skill name: yeet
