---
name: openai-linear
description: "Manage issues, projects & team workflows in Linear. Use when the user wants to read, create or updates tickets in Linear. (Imported from openai upstream skills)"
version: "1.0.0"
...
- Provider source: https://github.com/openai/skills/tree/main/skills/.curated/linear
- Original skill name: linear
