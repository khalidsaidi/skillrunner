...
description: "Use when the user asks to generate or edit images via the OpenAI Image API (for example: generate image, edit/inpaint/mask, background removal or replacement, transparent background, product shots, concept art, covers, or batch variants); run the bundled CLI (`scripts/image_gen.py`) and require `OPENAI_API_KEY` for live calls. (Imported from openai upstream skills)"
version: "1.0.0"
tags: ["openai", "upstream", "imported"]
kind: knowledge
risk: low
availability: advanced
docs:
  source: "https://github.com/openai/skills/tree/main/skills/.curated/imagegen"
---
...
- Provider source: https://github.com/openai/skills/tree/main/skills/.curated/imagegen
- Original skill name: imagegen
